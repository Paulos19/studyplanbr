...
import { ArrowRight, BookOpen, AlertTriangle } from "lucide-react"; // Adicionei AlertTriangle
...
export async function MyPlansList() {
  ...
  try {
    ...
    return (
      <>
        {plans.map((plan) => {
          ...
          // Evita divisão por zero explicitamente, embora o seu código original já funcionasse
    ...
    // Retorna UI de erro amigável em vez de quebrar a página
    return (
      <div className="col-span-full p-6 border border-red-200 bg-red-50 dark:bg-red-900/10 rounded-xl flex items-center gap-4 text-red-600 dark:text-red-400">
